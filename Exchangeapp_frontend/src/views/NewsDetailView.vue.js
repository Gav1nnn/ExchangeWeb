...
function __VLS_template() {
    ...
    if (__VLS_ctx.article) {
        ...
        // @ts-ignore
        [article, article,];
        __VLS_elementAsFunction(__VLS_intrinsicElements.p, __VLS_intrinsicElements.p)({ ...{ class: ("article-meta") }, });
        (__VLS_ctx.article.AuthorUsername || '未知作者');
        // @ts-ignore
        [article,];
        ...
        if (__VLS_ctx.canManageArticle) {
            ...
            // @ts-ignore
            [ElButton, ElButton,];
            const __VLS_27 = __VLS_asFunctionalComponent(__VLS_26, new __VLS_26({ ...{ 'onClick': {} }, plain: (true), }));
            const __VLS_28 = __VLS_27({ ...{ 'onClick': {} }, plain: (true), }, ...__VLS_functionalComponentArgsRest(__VLS_27));
            ({}({ ...{ 'onClick': {} }, plain: (true), }));
            let __VLS_32;
            const __VLS_33 = {
                onClick: (__VLS_ctx.editArticle)
            };
            // @ts-ignore
            [canManageArticle, editArticle,];
